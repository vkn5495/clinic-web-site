...
const Contact = () => {
  const contact = [
    ...
    {
      head: "Landmarks:",
      text: ["Near O’ Coqueiro", "Next to Biryani Palace"],
    },
    {
      head: "Clinic timings:",
      text: ["9.00 am - 1.00 pm & 4.00 pm – 8.00 pm"],
    },
    {
      head: "Telephone",
      text: ["+91 9021594170"],
                  ...
                  {contact?.map((item, id) => {
                    return (
                      <div key={id} className="first_row_details_box">
                        <div className="first_row_details_box_head">
                          {item?.head}
                        </div>
                        <div className="first_row_details_box_des">
                          {item?.text?.map((u, i) => {
                            return (
                              <div
                                key={i}
                                className="first_row_details_box_des_item"
                              >
                                {u}
                              </div>
                            );
